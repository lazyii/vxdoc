 ...
 */
public class ApiInfoTaglet extends BaseTaglet implements InheritableTaglet {
    public static String tag = VxTag.apiInfo;
    
    
    public ApiInfoTaglet() {
        this.name = tag;
    }
    ...
    public static void register(Map tagletMap) {
        ApiInfoTaglet tag = new ApiInfoTaglet();
